                ...
                <div class="card">
                    <div class="card-content">
                        <div class="row">
                            ...
                            <form id="checkout"action="/customer/{{$customer->id}}/checkout/place-order" method="post">
                                @csrf
                                ...
                                <div class="col s12">                                 
                                    ...
                                    @endforeach
                                    <a class="waves-effect waves-light btn modal-trigger blue right w-100" href="#receipt">Place order</a>
                                </div>
                                <div id="gcash" class="modal">
                                    <div class="modal-content">
                                        <h4 class="center">Gcash Payment</h4>
                                        <br>
                                        <div class="">
                                            <h4>Total:
                                                @php
...
<div id="receipt" class="modal">
    <div class="modal-content">
        <h4 class="center">AS Lukban Autosupply </h4>
        <p class="text-bold">Shipping Address:</p>
        <p style="text-transform:lowercase">{{$address->first()->street}} {{$address->first()->barangay_description}} {{$address->first()->city_municipality_description}} {{$address->first()->province_description}}</p>
        <div class="table-wrapper">
    ...
    <div class="modal-footer">
        <div class="row">
            <div class="col s6">
                <button type="submit"form="checkout"class="btn blue w-100 green darken-2">Accept</button>
            </div>
            <div class="col s6">
                <a href="#!" class="modal-close btn w-100 red">Cancel</a>
            </div>
        </div>
